...
#g++ -std=c++11 -fopenmp parallelSOSPwithLoopSelectionWithoutCritical.cpp -o parallelSOSPwithLoopSelectionWithoutCritical -g -lstdc++ -lgomp && ./parallelSOSPwithLoopSelectionWithoutCritical -g weightedGraph.mtx -c changeEdges.mtx -s 1